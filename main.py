...
def main():
    st.title("Code Executor & GPT-4o-mini Chat with Sidebar")

    # Sidebar tabs
    tab = st.sidebar.selectbox("Select Option", ["API", "Chat"])

    if tab == "API":
        st.sidebar.subheader("Code Executor")
        st.sidebar.write(
            """
            Write Python code and run it. You can visualize data using Plotly, Altair, and more.
            """
        )
        ...
        st.sidebar.subheader("GPT-4o-mini Chat")
